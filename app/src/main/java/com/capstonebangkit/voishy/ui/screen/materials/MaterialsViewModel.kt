...
class MaterialsViewModel(private val repository: Repository, private val articleRepository: ArticleRepository): ViewModel() {
    private val _movieList = MutableStateFlow<List<ResultsItem>>(emptyList())
    val movieList : StateFlow<List<ResultsItem>> get() = _movieList
    ...
    init {
        viewModelScope.launch {
            _movieList.value = repository.getNews()
